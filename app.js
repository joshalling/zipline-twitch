angular.module('twitchApp', [])
  .controller('streamerCtrl', ['$scope', '$http', function($scope, $http) {
    
    // Scope variables. streams will hold all the data, while streamsDisplay will be filtered based on user interation.
    $scope.streams = [];
